    ...
    <main className="flex-1 min-w-0 overflow-auto">
      <div className="max-w-[1440px] mx-auto animate-fade-in">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4">
          <CampaignStats
            title={t('campaignsPage.metrics.emailsSent')}
            value={totalMetrics.emailsSent.toLocaleString()}
            trend="+12.5%"
            description={t('campaignsPage.metrics.comparison')}
          />
          <CampaignStats
            title={t('campaignsPage.metrics.conversions')}
            value={totalMetrics.conversions.toLocaleString()}
            trend="+8.2%"
            description={t('campaignsPage.metrics.comparison')}
          />
          <CampaignStats
            title={t('campaignsPage.metrics.spent')}
          ...
          <Card>
            <CardHeader>
              <div className="flex flex-wrap items-center gap-4">
                ...
                >
                  <option value="all">{t('campaignsPage.filters.allStatus')}</option>
                ...
                <select
                  ...
                  className="px-4 py-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-dark-hover text-gray-900 dark:text-white focus:ring-2 focus:ring-primary/20 focus:border-primary"
                >
                  <option value="all">{t('campaignsPage.filters.allTypes')}</option>

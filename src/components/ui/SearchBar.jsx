...
export function SearchBar() {
  ...
  const searchResults = [
    { type: 'customer', name: 'Carmen Rodríguez', path: '/customers/1' },
    { type: 'customer', name: 'Roberto Martínez', path: '/customers/2' },
    { type: 'product', name: 'Plan Premium', path: '/products/1' },
    { type: 'campaign', name: 'Oferta de Verano', path: '/campaigns/1' },
  ].filter(item => 
  ...
  return (
    <>
      ...
      >
        ...
        <span className="flex-1 text-left hidden sm:block">{t('header.searchPlaceholder')}</span>

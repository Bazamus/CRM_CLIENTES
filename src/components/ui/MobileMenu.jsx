...
export function MobileMenu({ isOpen, onClose, currentPage, onNavigate, t }) {
  const menuItems = [
    { id: 'dashboard', label: t('sidebar.dashboard'), icon: HomeIcon },
    { id: 'customers', label: t('sidebar.customers'), icon: CustomersIcon },
    { id: 'conversations', label: t('sidebar.conversations'), icon: ConversationsIcon },
    { id: 'campaigns', label: t('sidebar.campaigns'), icon: CampaignsIcon },
    { id: 'reporting', label: t('sidebar.reporting'), icon: ReportingIcon },
  ];

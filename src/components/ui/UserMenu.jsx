...
const userNavigation = [
  { id: 'profile', name: 'Tu Perfil', icon: 'user' },
    ...
    <Menu as="div" className="relative">
      ...
      <Menu.Items className="absolute right-0 mt-1 w-56 bg-white dark:bg-dark-card rounded-xl shadow-lg border border-gray-100 dark:border-gray-800 focus:outline-none">
        <div className="p-4 border-b border-gray-100 dark:border-gray-800">
          <p className="text-sm font-medium text-gray-900 dark:text-white">Carmen Rodríguez</p>
          <p className="text-sm text-gray-500 dark:text-gray-400">carmen@ejemplo.es</p>
        </div>

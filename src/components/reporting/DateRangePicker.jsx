...
const ranges = [
  { value: '7d', label: 'reporting.dateRanges.7d' },
  { value: '30d', label: 'reporting.dateRanges.30d' },
  { value: '90d', label: 'reporting.dateRanges.90d' },
  { value: 'ytd', label: 'reporting.dateRanges.ytd' },
  { value: '12m', label: 'reporting.dateRanges.12m' },
];
  ...
  return (
    <Menu as="div" className="relative">
      <Menu.Button className="flex items-center gap-2 px-4 py-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-dark-hover text-gray-900 dark:text-white hover:bg-gray-50 dark:hover:bg-dark-card transition-colors">
        <span>{t(selectedRange?.label)}</span>

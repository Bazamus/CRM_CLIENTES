...
const initialConversations = [
  {
    ...
    lastMessage: {
      text: 'Necesito ayuda con mi pedido reciente',
    ...
    messages: [
      {
        id: 1,
        type: 'customer',
        text: 'Hola, necesito ayuda con mi pedido reciente',
        timestamp: '2023-12-22T10:30:00Z'
      },
      {
        id: 2,
        type: 'agent',
        text: '¡Hola Carmen! Estaré encantado de ayudarte. ¿Podrías proporcionarme el número de tu pedido?',
    ...
    messages: [
      {
        id: 1,
        type: 'customer',
        text: 'Tengo una pregunta sobre el producto',

...
const integrations = [
  {
    id: 'hubspot',
    name: 'HubSpot',
    description: 'Sincroniza contactos, acuerdos y campañas de marketing',
    connected: true,
    icon: (
  ...
  },
  {
    id: 'salesforce',
    name: 'Salesforce',
    description: 'Sincronización bidireccional de datos de clientes y oportunidades',
    connected: false,
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256">
  ...
  },
  {
    id: 'mailchimp',
    name: 'Mailchimp',
    description: 'Automatización de marketing por correo electrónico y segmentación de clientes',
    connected: true,
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256">
  ...
  },
  {
    id: 'zendesk',
    name: 'Zendesk',
    description: 'Integración y seguimiento de tickets de soporte al cliente',
    connected: false,
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256">
  ...
  },
  {
    id: 'zapier',
    name: 'Zapier',
    description: 'Automatiza flujos de trabajo con más de 3000 aplicaciones',
    connected: false,
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 256 256">
...
export function IntegrationSettings() {
  return (
    <Card>
      <CardHeader>
        <h2 className="text-gray-900 dark:text-white text-lg font-semibold">Integraciones</h2>
      </CardHeader>
      <CardContent>
